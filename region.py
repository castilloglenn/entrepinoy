...
class Map():
    ...
    def __init__(self, main):
        ...
        self.location_a_button = Button(
            self.main, self.location_a_callback,
        ...
        self.location_b_button = Button(
            self.main, self.location_b_callback,
            top_left_coordinates=(0, 0),
        ...
        self.location_c_button = Button(
            self.main, self.location_c_callback,
            top_left_coordinates=(0, 0),
        ...
        self.location_d_button = Button(
            self.main, self.location_d_callback,
            top_left_coordinates=(0, 0),
        ...
        self.location_e_button = Button(
            self.main, self.location_e_callback,
            top_left_coordinates=(0, 0),
        ...
        self.location_f_button = Button(
            self.main, self.location_f_callback,
            top_left_coordinates=(0, 0),
